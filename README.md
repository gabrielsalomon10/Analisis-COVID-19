# COVID-19
## Iniciamos el trabajo analizando un archivo .XLS con mas de 12 millones de filas y 50 columnas donde mi objetivo final es obtener insights para poder expersarlos en el tablero de control.
